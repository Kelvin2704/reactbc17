...
//   isLogin = false;
  ...
  handleLogin = () => {
    // this.state.isLogin = true; không được gắn giá trị state trực tiếp mà phải thông qua phương thức setState
    console.log("islogin: ", this.state.isLogin);
    /**
     * this.setState là phương thức sẵn có của react class component dùng để thay đổi giá trị của state. Hàm setState sẽ nhận vào gái trị state mới và gọi lại hàm render => giao diện thay đổi
